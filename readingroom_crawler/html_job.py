...
def total_seat_number(htmlstuff : HTML):
    ...
    data = bsObject.select("body > center > table:nth-of-type(2) > tr > td > table > tr")
    ...
    return tuple([get_seat_number_of(x, total_seats) for x in [SEAT_TOTAL,SEAT_USED,SEAT_UNUSED]])
